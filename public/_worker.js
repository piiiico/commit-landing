...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <sitemap><loc>https://getcommit.dev/sitemap-package.xml</loc><lastmod>${today}</lastmod></sitemap>
    ...
    if (cleanPath === "/sitemap-blog.xml" || cleanPath === "/sitemap-blog") {
      ...
      // GENERATED-EDIT-OK: switched from blogSlugs[] to blogPosts[] with actual publishDate per entry; added 7 missing posts (2026-06-11)
      // slug → publishDate (actual post date, NOT today — lets crawlers know what's actually new)
      const blogPosts = [
        ["redhat-miasma-provenance-bypass",            "2026-06-01"],
        ["microsoft-14-typosquatted-packages",         "2026-06-01"],
        ["osv-157-false-positives",                    "2026-05-31"],
        ["may-2026-npm-attacks-roundup",               "2026-05-30"],
        ["cursor-hook-supply-chain-gate",              "2026-05-29"],
        ["shai-hulud-claude-code-hook",                "2026-05-25"],
        ["drizzle-kit-stale-transitive-dep",           "2026-05-25"],
        ["stripe-google-cloud-critical",               "2026-05-24"],
        ["antv-supply-chain-attack",                   "2026-05-23"],
        ["npm-supply-chain-audit-checklist",           "2026-05-22"],
        ["two-attacks-one-week",                       "2026-05-21"],
        ["tanstack-mini-shai-hulud-behavioral-analysis","2026-05-19"],
        ["compliance-theater-behavioral-proof",        "2026-05-16"],
        ["critical-flag-silent-regression",            "2026-05-16"],
        ["npm-trusted-publishing-provenance",          "2026-05-16"],
        ["scorecard-vs-behavioral",                    "2026-05-15"],
        ["trusted-publishing-adoption",                "2026-05-14"],
        ["github-repo-scanner",                        "2026-05-14"],
        ["ai-sdk-supply-chain-ranking",                "2026-05-13"],
        ["transitive-risk-methodology",                "2026-05-13"],
        ["four-ecosystems-one-vulnerability",          "2026-05-09"],
        ["go-supply-chain-different-risk",             "2026-05-09"],
        ["pnpm-monorepo-supply-chain-audit",           "2026-05-09"],
        ["ai-slop-commitment-problem",                 "2026-05-08"],
        ["cargo-supply-chain-risk",                    "2026-05-08"],
        ["evaluation-awareness",                       "2026-05-07"],
        ["python-supply-chain-risk",                   "2026-05-04"],
        ["behavioral-trust-vs-surveillance",           "2026-04-30"],
        ["express-supply-chain",                       "2026-04-29"],
        ["invisible-critical-packages",                "2026-04-29"],
        ["agents-md-package-trust",                    "2026-04-29"],
        ["proof-of-commitment-internals",              "2026-04-29"],
        ["agents-installing-dependencies",             "2026-04-28"],
        ["lockfile-scan",                              "2026-04-28"],
        ["anthropic-sdk-transitive-risk",              "2026-04-26"],
        ["two-types-npm-attacks",                      "2026-04-26"],
        ["axios-attack-prediction",                    "2026-04-24"],
        ["benchmarks-lied",                            "2026-04-24"],
        ["benchmarks-soc2",                            "2026-04-24"],
        ["declarations-are-gameable",                  "2026-04-24"],
        ["npm-trust-q2-2026",                          "2026-04-24"],
        ["bitwarden-cli-scored-92",                    "2026-04-23"],
        ["25-npm-packages-scored",                     "2026-04-21"],
        ["commit-vs-socket-snyk-npm-audit",            "2026-04-21"],
        ["hono-critical",                              "2026-04-21"],
        ["npm-audit-zero-vulnerabilities",             "2026-04-21"],
        ["payment-layer-governance",                   "2026-04-21"],
        ["trust-gap-agentic-infrastructure",           "2026-04-21"],
        ["ci-trust-scoring-tutorial",                  "2026-04-19"],
        ["event-stream-autopsy",                       "2026-04-19"],
        ["mcp-security-landscape-2026",                "2026-04-19"],
        ["the-axios-signal",                           "2026-04-19"],
        ["3000-autonomous-agent-tasks",                "2026-04-18"],
        ["state-of-npm-trust-april-2026",              "2026-04-18"],
        ["the-10-billion-trust-data-market",           "2026-04-18"],
        ["three-npm-disasters-that-were-predictable",  "2026-04-18"],
        ["after-agents-week",                          "2026-04-15"],
        ["cloudflare-pre-iam-moment",                  "2026-04-17"],
        ["five-identity-frameworks",                   "2026-04-17"],
        ["mcp-security-crisis",                        "2026-04-20"],
        ["scoring-methodology",                        "2026-04-20"],
        ["ai-lies-about-your-favorite-restaurant",     "2026-04-04"],
        ["amazon-perplexity-platform-trust",           "2026-04-10"],
        ["five-stars-zero-commitment",                 "2026-04-11"],
        ["toctou-of-trust",                            "2026-04-11"],
        ["germany-eidas-runtime-attestation",          "2026-04-05"],
        ["how-commit-extension-works",                 "2026-04-05"],
        ["caveman-pricing-principle",                  "2026-04-06"],
        ["the-missing-layer",                          "2026-04-06"],
        ["mcp-server-60-seconds",                      "2026-04-03"],
        ["mythos-paradox",                             "2026-04-08"],
        ["commitment-is-the-new-link",                 "2026-03-28"],
        // June 2026 posts (previously missing from sitemap)
        // GENERATED-EDIT-OK: this IS the source of truth for sitemap blog list per file header line 1-4; adding the 2026-06-12 Mini Shai-Hulud post to the hardcoded sitemap-blog.xml list so the new article gets crawled.
        ["mini-shai-hulud-source-code-public",         "2026-06-12"],
        ["agent-phishing-identity-stack",              "2026-06-11"],
        ["phantom-gyp-binding-gyp-bypass",             "2026-06-10"],
        ["ironworm-rust-malware-targets-ai-credentials","2026-06-06"],
      ...
      for (const [slug, date] of blogPosts) {
        xml += `  <url><loc>https://getcommit.dev/blog/${slug}/</loc><changefreq>monthly</changefreq><lastmod>${date}</lastmod><priority>0.7</priority></url>\n`;
      }
      xml += `</urlset>`;
      return new Response(xml, { headers: { "Content-Type": "application/xml; charset=utf-8", "Cache-Control": "public, max-age=86400" } });
    }
    ...
    // GENERATED-EDIT-OK: public/_worker.js IS the source of truth per file header — expanded sitemap-package from 125 to 217 packages to match 2026-06-12 rankings expansion
    // ── /sitemap-package.xml — 217 package profile pages ────────────
    if (cleanPath === "/sitemap-package.xml" || cleanPath === "/sitemap-package") {
      const packageSlugs = [
        "semver","minimatch","debug","ansi-styles","strip-ansi","chalk","commander","ms",
        "wrap-ansi","lru-cache","picomatch","string-width","tslib","supports-color","glob","@types__node",
        "source-map","color-name","color-convert","ajv","readable-stream","escape-string-regexp","which","glob-parent",
        "has-flag","p-locate","safe-buffer","json-schema-traverse","signal-exit","yallist","p-limit","postcss",
        "locate-path","string_decoder","uuid","https-proxy-agent","esbuild","agent-base","isarray","ws",
        "cross-spawn","typescript","inherits","graceful-fs","yargs","qs","is-glob","zod",
        "braces","fs-extra","fill-range","lodash","form-data","chokidar","node-fetch","@babel__core",
        "fast-glob","dotenv","execa","react","vite","mkdirp","micromatch","minimist",
        "react-dom","@types__react","undici","rimraf","http-proxy-agent","axios","tailwindcss","eslint",
        "body-parser","prettier","serve-static","once","rollup","@types__react-dom","express","async",
        "jose","rxjs","date-fns","jsdom","ora","typescript-eslint","chai","terser",
        "sharp","playwright","cors","vitest","jest-mock","dayjs","autoprefixer","immer",
        "webpack","bluebird","react-router","inquirer","jsonwebtoken","jest","hono","react-router-dom",
        "@testing-library__jest-dom","graphql","@babel__preset-env","zustand","handlebars","@modelcontextprotocol__sdk","lodash-es","cheerio",
        "@testing-library__react","@swc__core","compression","moment","ejs","luxon","pg","@aws-sdk__client-s3",
        "tweetnacl","rc","next","got","node-forge","pino","redux","sass",
        "openai","archiver","underscore","ua-parser-js","@anthropic-ai__sdk","joi","ioredis","@babel__preset-react",
        "winston","@tanstack__react-router","preact","@reduxjs__toolkit","superagent","crypto-js","multer","cross-env",
        "request","concurrently","supertest","socket.io","mocha","turbo","q","unzipper",
        "@google-cloud__storage","vue","ai","yup","ramda","helmet","morgan","@nestjs__common",
        "puppeteer","@nestjs__core","papaparse","sinon","redis","prisma","nodemon","drizzle-orm",
        "class-validator","mysql2","cookie-parser","xlsx","less","bcryptjs","stylelint","firebase",
        "aws-sdk","@ai-sdk__openai","passport","@ai-sdk__anthropic","better-sqlite3","fastify","@apollo__client","log4js",
        "koa","nock","lit","event-stream","cypress","@angular__core","mongoose","@angular__cli",
        "bcrypt","coa","svelte","@langchain__core","knex","mobx","jotai","typeorm",
        "@langchain__openai","bunyan","pug","csv-parser","@apollo__server","pm2","solid-js","sequelize",
        "langchain","node-ipc","recoil","chalk-animation","parcel","x402","llamaindex","hapi","nestjs",
      ];
      const today = new Date().toISOString().split("T")[0];
      let xml = `<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n`;
